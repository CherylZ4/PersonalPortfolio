...
export default function Projects() {
  return (
    <div className="scrollable-container h-[2400]px sm:h-[2100px] md:h-[1600px] lg:h-[1200px] xl:h-[1200px] overflow-y-scroll relative">
      <div className="h-full bg-cover bg-center flex flex-col items-start justify-start px-4"
          ...
          <FadeIn>
            <div className="flex-col-reverse sm:flex-row md:flex-row lg:flex-row xl:flex-row flex items-center">
              <div>
                ...
                <h1 className='text-custom-gray font-brygada-1918 text-xl font-normal italic mb-2 ml-6'>Winner of Best Mobile App at Ignition Hacks 2023</h1>
                <p className='text-custom-gray font-brygada-1918 text-lg ml-6'>Worked with a team of 3 to create a web app where users upload audio/video files of their meetings and the app will take that file and convert it into condensed and informative meeting minutes.
