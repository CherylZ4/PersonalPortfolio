...
{/* Hello I'm */}
<h1 className={`text-custom-gray font-inter font-thin text-2xl ml-40 mb-2 ${isVisible.hello ? '' : 'opacity-0'}`}>
        Hello I'm
      </h1>

      {/* Cheryl */}
      <h1 className={`text-custom-gray font-brygada-1918 text-8xl font-medium ml-40 ${isVisible.cheryl ? '' : 'opacity-0'}`}>
        Cheryl
      </h1>

      {/* Zhang */}
      <h1 className={`text-custom-gray font-brygada-1918 text-8xl font-medium ml-40 ${isVisible.zhang ? '' : 'opacity-0'}`}>
        Zhang
      </h1>
   
   
   <div  className={`ml-auto flex flex-col items-end ${
          isVisible.developer ? '' : 'opacity-0'
        }`}>
