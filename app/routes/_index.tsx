...
export default function Index() {
  ...
  return (
    ...
    <div className="scrollable-container h-[1330px] overflow-y-scroll relative">
      <div className="h-full bg-cover bg-center flex flex-col items-start px-4"
      
        style={{ backgroundImage: `url(${backgroundImage})` }}>

        <h1 className={`text-custom-gray font-inter font-thin text-2xl ml-40 mb-2 mt-40 ${isVisible.hello ? 'opacity-100 transition-opacity duration-500 ease-in' : 'opacity-0'}`}>
          Hello, I'm
        </h1>
        ...
        <div className= "ml-5">
        <div className="flex flex-col items-center justify-start ml-80 mt-20">
        <Fade duration={2000}>
        ...
        <Fade duration={7000}>
          ...
          <Fade duration={7000}>
            ...
            <a href="https://devpost.com/cherylzhang8?ref_content=user-portfolio&ref_feature=portfolio&ref_medium=global-nav" target="_blank" className="text-custom-gray hover:text-custom-hover font-inter text-lg">devpost </a>
            {/* <a
        href="#"
        onClick={(e) => {
      ...
      {showPDF && <PDFViewer pdfUrl="../pdfs/Resume.pdf"/>} */}
      </Fade>
      </div>
